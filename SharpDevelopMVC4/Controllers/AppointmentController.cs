		...
		public ActionResult Index()
		{
     		if(Session["user"] != null)
			{
     			if(User.IsInRole("owner"))
     			{
     				...
     				List<Appointment> Adminappointment = _db.Appointments.Where(x => x.VetId == VetUserId).OrderByDescending(o => o.Id).ToList();
			...
			List<Appointment> appointment = _db.Appointments.Where(x => x.VetId == userId).OrderByDescending(o => o.Id).ToList();
